...
class TraceManager
{
 ...
 public:
   TraceManager(SimulationContext *context);
   ~TraceManager();
   void init();
   void start();
   void stop();
   ...
   void accessMemory(int core_id, Core::lock_signal_t lock_signal, Core::mem_op_t mem_op_type, IntPtr d_addr,
