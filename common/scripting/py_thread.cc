...
static PyObject *setThreadAffinity(PyObject *self, PyObject *args)
{
   ...
   bool result = Sim()->getThreadManager()->getScheduler()->threadSetAffinity(INVALID_THREAD_ID, thread_id,
...
static PyModuleDef PyThreadModule = {
    PyModuleDef_HEAD_INIT, "sim_thread", "", -1, PyThreadMethods, NULL, NULL, NULL, NULL};
