...
class Config
{
 public:
   ...
   {
      return m_knob_num_host_cores;
   }
   bool getEnableSMCSupport() const
   {
      return m_knob_enable_smc_support;
   }
   void forceEnableSMCSupport()
   {
      m_knob_enable_smc_support = true;
   }
   ...
   {
      return m_knob_enable_icache_modeling;
   }
   ...
   {
      return m_knob_enable_progress_trace;
   }
   bool getEnableSync() const
   {
      return m_knob_enable_sync;
   }
   bool getEnableSyncReport() const
   {
      return m_knob_enable_sync_report;
   }
   bool getOSEmuPthreadReplace() const
   {
      return m_knob_osemu_pthread_replace;
   }
   UInt32 getOSEmuNprocs() const
   {
      return m_knob_osemu_nprocs;
   }
   bool getOSEmuClockReplace() const
   {
      return m_knob_osemu_clock_replace;
   }
   time_t getOSEmuTimeStart() const
   {
      return m_knob_osemu_time_start;
   }
   ...
   {
      return m_knob_hpi_percore;
   }
   UInt64 getHPIInstructionsGlobal() const
   {
      return m_knob_hpi_global;
   }
   ...
   {
      return m_suppress_stdout;
   }
   bool suppressStderr() const
   {
      return m_suppress_stderr;
   }
   bool getEnablePinPlay() const
   {
      return m_knob_enable_pinplay;
   }
   ...
   ComponentPeriod getCoreFrequency() const
   {
      return m_knob_core_frequency;
   }
   ...
   void setCacheEfficiencyCallbacks(CacheEfficiencyTracker::CallbackGetOwner get_owner_func,
 ...
 private:
   ...
   static ComponentPeriod m_knob_core_frequency;
