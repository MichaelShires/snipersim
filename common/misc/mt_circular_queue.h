...
template <class T> void MTCircularQueue<T>::full_wait(void)
{
   ScopedLock sl(m_lock);
   full_wait_locked();
}

template <class T> void MTCircularQueue<T>::full_wait_locked(void)
{
   while (CircularQueue<T>::full())
      m_full.wait(m_lock);
}

template <class T> void MTCircularQueue<T>::empty_wait(void)
{
   ScopedLock sl(m_lock);
   empty_wait_locked();
}

template <class T> void MTCircularQueue<T>::empty_wait_locked()
{
   while (CircularQueue<T>::empty())
      m_empty.wait(m_lock);
}

template <class T> void MTCircularQueue<T>::push_locked(const T &t)
{
...
template <class T> void MTCircularQueue<T>::push(const T &t)
{
   ScopedLock sl(m_lock);
   push_locked(t);
}

template <class T> void MTCircularQueue<T>::push_wait(const T &t)
{
   ScopedLock sl(m_lock);
   full_wait_locked();
   push_locked(t);
...
template <class T> T MTCircularQueue<T>::pop_locked()
{
...
template <class T> T MTCircularQueue<T>::pop()
{
   ScopedLock sl(m_lock);
   return pop_locked();
}

template <class T> T MTCircularQueue<T>::pop_wait()
{
   ScopedLock sl(m_lock);
   empty_wait_locked();
   return pop_locked();
