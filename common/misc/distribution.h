...
class NormalFloatDistribution : public FloatDistribution
{
 ...
 private:
   // The following code is for C++ 2011 only (-std-c++11). C++0x in GCC 4.4 does not support this, but it does support
   // the TR1 implementation std::default_random_engine generator; std::normal_distribution<double> distribution;
