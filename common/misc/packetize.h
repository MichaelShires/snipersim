...
class UnstructuredBuffer
{
 ...
 public:
   ...
   // Wrappers
   template <class T> UnstructuredBuffer &operator<<(const T &data);
   template <class T> UnstructuredBuffer &operator>>(T &data);

   template <class T, class I> UnstructuredBuffer &operator<<(std::pair<T *, I> buffer);
   template <class T, class I> UnstructuredBuffer &operator>>(std::pair<T *, I> buffer);
...
template <class T> UnstructuredBuffer &UnstructuredBuffer::operator<<(const T &data)
{
   put<T>(data);
   return *this;
}
...
template <> inline UnstructuredBuffer &UnstructuredBuffer::operator<<(const SubsecondTime &_data)
{
...
template <class T> UnstructuredBuffer &UnstructuredBuffer::operator>>(T &data)
{
...
// Specialize for SubsecondTime
template <> inline UnstructuredBuffer &UnstructuredBuffer::operator>>(SubsecondTime &_data)
{
   subsecond_time_t data;
...
template <class T, class I> UnstructuredBuffer &UnstructuredBuffer::operator<<(std::pair<T *, I> buffer)
{
