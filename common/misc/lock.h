...
class LockCreator_Recursive : public LockCreator
{
 public:
   static LockImplementation *create();
};
...
typedef TLock<LockCreator_Recursive> RecursiveLock;
...
class ScopedLock
{
 ...
 public:
   ScopedLock(BaseLock &lock) : _lock(lock)
   {
      _lock.acquire();
   }
...
class ScopedReadLock
{
 ...
 public:
   ScopedReadLock(BaseLock &lock) : _lock(lock)
   {
      _lock.acquire_read();
   }
