...
typedef void (*CallbackNotifyAccess)(UInt64 user, UInt64 owner, Core::mem_op_t mem_op_type,
                                     HitWhere::where_t hit_where);
typedef void (*CallbackNotifyEvict)(UInt64 user, bool on_roi_end, UInt64 owner, UInt64 evictor,
...
struct Callbacks
{
   ...
   void call_notify_evict(bool on_roi_end, UInt64 owner, UInt64 evictor, CacheBlockInfo::BitsUsedType bits_used,
