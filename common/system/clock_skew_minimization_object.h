...
class ClockSkewMinimizationClient : public ClockSkewMinimizationObject
{
 ...
 public:
   ...
   static ClockSkewMinimizationClient *create(Core *core, SimulationContext *context);

   virtual void enable() = 0;
   virtual void disable() = 0;
   virtual void synchronize(SubsecondTime time = SubsecondTime::Zero(), bool ignore_time = false,
                            bool abort_func(void *) = NULL, void *abort_arg = NULL) = 0;
};
...
class ClockSkewMinimizationManager : public ClockSkewMinimizationObject
{
 ...
 public:
   ...
   static ClockSkewMinimizationManager *create(SimulationContext *context);
...
class ClockSkewMinimizationServer : public ClockSkewMinimizationObject
{
 ...
 public:
   ...
   static ClockSkewMinimizationServer *create(SimulationContext *context);
