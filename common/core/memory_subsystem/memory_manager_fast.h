...
class MemoryManagerFast : public MemoryManagerBase
{
 ...
 public:
   MemoryManagerFast(Core *core, Network *network, ShmemPerfModel *shmem_perf_model, SimulationContext *context)
                                              ...
                                              UInt32 data_length, Core::MemModeled modeled)
   {
      ...
      SubsecondTime latency =
          coreInitiateMemoryAccessFast(mem_component == MemComponent::L1_ICACHE ? true : false, mem_op_type, address);
