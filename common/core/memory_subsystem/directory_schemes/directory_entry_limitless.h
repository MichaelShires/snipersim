...
template <class DirectorySharers> class DirectoryEntryLimitless : public DirectoryEntrySized<DirectorySharers>
{
 private:
...
DirectoryEntryLimitless<DirectorySharers>::DirectoryEntryLimitless(UInt32 max_hw_sharers, UInt32 max_num_sharers,
                                                                   SubsecondTime software_trap_penalty)
    : DirectoryEntrySized<DirectorySharers>(max_hw_sharers, max_num_sharers), m_software_trap_enabled(false),
      m_software_trap_penalty(software_trap_penalty)
{
}

template <class DirectorySharers> DirectoryEntryLimitless<DirectorySharers>::~DirectoryEntryLimitless()
{
}

template <class DirectorySharers> SubsecondTime DirectoryEntryLimitless<DirectorySharers>::getLatency()
{
...
template <class DirectorySharers> bool DirectoryEntryLimitless<DirectorySharers>::hasSharer(core_id_t sharer_id)
{
...
template <class DirectorySharers>
bool DirectoryEntryLimitless<DirectorySharers>::addSharer(core_id_t sharer_id, UInt32 max_hw_sharers)
{
...
template <class DirectorySharers>
void DirectoryEntryLimitless<DirectorySharers>::removeSharer(core_id_t sharer_id, bool reply_expected)
{
...
template <class DirectorySharers> core_id_t DirectoryEntryLimitless<DirectorySharers>::getOwner()
{
   return this->m_owner_id;
}

template <class DirectorySharers> void DirectoryEntryLimitless<DirectorySharers>::setOwner(core_id_t owner_id)
{
...
template <class DirectorySharers> core_id_t DirectoryEntryLimitless<DirectorySharers>::getOneSharer()
{
