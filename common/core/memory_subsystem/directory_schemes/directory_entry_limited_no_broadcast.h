...
template <class DirectorySharers> class DirectoryEntryLimitedNoBroadcast : public DirectoryEntrySized<DirectorySharers>
{
 public:
...
DirectoryEntryLimitedNoBroadcast<DirectorySharers>::DirectoryEntryLimitedNoBroadcast(UInt32 max_hw_sharers,
...
template <class DirectorySharers>
bool DirectoryEntryLimitedNoBroadcast<DirectorySharers>::hasSharer(core_id_t sharer_id)
{
...
template <class DirectorySharers>
bool DirectoryEntryLimitedNoBroadcast<DirectorySharers>::addSharer(core_id_t sharer_id, UInt32 max_hw_sharers)
{
...
template <class DirectorySharers>
void DirectoryEntryLimitedNoBroadcast<DirectorySharers>::removeSharer(core_id_t sharer_id, bool reply_expected)
{
...
template <class DirectorySharers> core_id_t DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getOwner()
{
   return this->m_owner_id;
}

template <class DirectorySharers> void DirectoryEntryLimitedNoBroadcast<DirectorySharers>::setOwner(core_id_t owner_id)
{
...
template <class DirectorySharers> core_id_t DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getOneSharer()
{
...
template <class DirectorySharers> SubsecondTime DirectoryEntryLimitedNoBroadcast<DirectorySharers>::getLatency()
{
