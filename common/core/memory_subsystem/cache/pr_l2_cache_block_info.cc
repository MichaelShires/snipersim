...
{
   LOG_ASSERT_ERROR(cached_loc != MemComponent::INVALID_MEM_COMPONENT, "m_cached_loc_bitvec(%u), cached_loc(%u)",
                    m_cached_loc_bitvec, cached_loc);
   LOG_ASSERT_ERROR(!(m_cached_loc_bitvec & (1 << cached_loc)), "m_cached_loc_bitvec(%u), cached_loc(%u)",
                    m_cached_loc_bitvec, cached_loc);
