...
class Cache : public CacheBase
{
 ...
 public:
   ...
   Cache(String name, String cfgname, core_id_t core_id, UInt32 num_sets, UInt32 associativity, UInt32 cache_block_size,
         String replacement_policy, cache_t cache_type, hash_t hash = CacheBase::HASH_MASK,
   ...
   CacheBlockInfo *accessSingleLine(IntPtr addr, access_t access_type, Byte *buff, UInt32 bytes, SubsecondTime now,
...
template <class T> UInt32 moduloHashFn(T key, UInt32 hash_fn_param, UInt32 num_buckets)
{
