...
class CacheBlockInfo
{
 public:
   ...
   typedef UInt8 BitsUsedType; // Enough to store one bit per 1<<BitsUsedOffset byte element per cache line (8 8-byte
                               // elements for 64-byte cache lines)
