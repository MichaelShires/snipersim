...
CacheSetLRU::CacheSetLRU(CacheBase::cache_t cache_type, UInt32 associativity, UInt32 blocksize,
...
static ComponentRegistrar<CacheSetInfo, String, String, core_id_t, UInt32> 
   lru_info_registrar("lru", [](String name, String cfgname, core_id_t core_id, UInt32 associativity) -> CacheSetInfo* {
      return new CacheSetInfoLRU(name, cfgname, core_id, associativity, CacheSet::getNumQBSAttempts(CacheBase::LRU, cfgname, core_id));
   });

static ComponentRegistrar<CacheSetInfo, String, String, core_id_t, UInt32> 
   lru_qbs_info_registrar("lru_qbs", [](String name, String cfgname, core_id_t core_id, UInt32 associativity) -> CacheSetInfo* {
      return new CacheSetInfoLRU(name, cfgname, core_id, associativity, CacheSet::getNumQBSAttempts(CacheBase::LRU_QBS, cfgname, core_id));
   });

static ComponentRegistrar<CacheSet, String, core_id_t, CacheBase::cache_t, UInt32, UInt32, CacheSetInfo*> 
   lru_registrar("lru", [](String cfgname, core_id_t core_id, CacheBase::cache_t cache_type, UInt32 associativity, UInt32 blocksize, CacheSetInfo *set_info) -> CacheSet* {
      return new CacheSetLRU(cache_type, associativity, blocksize, dynamic_cast<CacheSetInfoLRU*>(set_info), CacheSet::getNumQBSAttempts(CacheBase::LRU, cfgname, core_id));
   });

static ComponentRegistrar<CacheSet, String, core_id_t, CacheBase::cache_t, UInt32, UInt32, CacheSetInfo*> 
   lru_qbs_registrar("lru_qbs", [](String cfgname, core_id_t core_id, CacheBase::cache_t cache_type, UInt32 associativity, UInt32 blocksize, CacheSetInfo *set_info) -> CacheSet* {
      return new CacheSetLRU(cache_type, associativity, blocksize, dynamic_cast<CacheSetInfoLRU*>(set_info), CacheSet::getNumQBSAttempts(CacheBase::LRU_QBS, cfgname, core_id));
   });
