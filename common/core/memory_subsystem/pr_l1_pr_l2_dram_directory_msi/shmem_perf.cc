...
const char *shmem_reason_names[] = {
    "noc-base",        "noc-queue",       "td-access",        "inv-imbalance",  "remote-cache-inv", "remote-cache-fwd",
    "remote-cache-wb", "pending-hit",     "nuca-tags",        "nuca-bus",       "nuca-queue",       "nuca-data",
    "dram-cache",      "dram-cache-tags", "dram-cache-queue", "dram-cache-bus", "dram-cache-data",  "dram",
    "dram-queue",      "dram-bus",        "dram-device",      "unknown",
};
...
ShmemPerf::ShmemPerf()
    : m_core_id(INVALID_CORE_ID), m_time_begin(SubsecondTime::Zero()), m_time_last(SubsecondTime::Zero()),
