...
DynamicMicroOpCortexA72::uop_port_t DynamicMicroOpCortexA72::getPort(const MicroOp *uop)
{
   ...
   case MicroOp::UOP_SUBTYPE_FP_MULDIV:          //        sending instructions to their corresponding port, as below
      return DynamicMicroOpCortexA72::UOP_PORT5; //        but right now Dynamorio cannot send us some SIMD
                                                 //        instructions...
...
DynamicMicroOpCortexA72::DynamicMicroOpCortexA72(const MicroOp *uop, const CoreModel *core_model,
                                                 ComponentPeriod period)
    : DynamicMicroOp(uop, core_model, period), uop_port(DynamicMicroOpCortexA72::getPort(uop)),
      uop_alu(DynamicMicroOpCortexA72::getAlu(uop)), uop_bypass(DynamicMicroOpCortexA72::getBypassType(uop))
{
}
