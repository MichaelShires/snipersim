...
CoreModelCortexA53::CoreModelCortexA53()
{
   ...
   instructionLatencies[ARM64_INS_EXTR] =
       3; // For 2 registers on the A53 (because it has the same latency for 1 register on the A53)
...
unsigned int CoreModelCortexA53::getBypassLatency(const DynamicMicroOp *uop) const
{
   ...
   LOG_ASSERT_ERROR(bypass_type >= 0 && bypass_type < DynamicMicroOpCortexA53::UOP_BYPASS_SIZE,
...
DynamicMicroOp *CoreModelCortexA53::createDynamicMicroOp(Allocator *alloc, const MicroOp *uop,
