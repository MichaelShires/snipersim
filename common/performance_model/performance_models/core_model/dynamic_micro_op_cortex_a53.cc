...
DynamicMicroOpCortexA53::DynamicMicroOpCortexA53(const MicroOp *uop, const CoreModel *core_model,
                                                 ComponentPeriod period)
    : DynamicMicroOp(uop, core_model, period), uop_port(DynamicMicroOpCortexA53::getPort(uop)),
      uop_alu(DynamicMicroOpCortexA53::getAlu(uop)), uop_bypass(DynamicMicroOpCortexA53::getBypassType(uop)),
