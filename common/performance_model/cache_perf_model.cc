...
CachePerfModel::CachePerfModel(const ComponentLatency &cache_data_access_time,
    ...
    : m_cache_data_access_time(cache_data_access_time), m_cache_tags_access_time(cache_tags_access_time)
{
}
...
CachePerfModel *CachePerfModel::create(String cache_perf_model_type, const ComponentLatency &cache_data_access_time,
                                       const ComponentLatency &cache_tags_access_time)
{
