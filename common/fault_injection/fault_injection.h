...
class FaultinjectionManager
{
 ...
 public:
   static FaultinjectionManager *create(SimulationContext *context);
   ...
   void applyFault(Core *core, IntPtr read_address, UInt32 data_size, MemoryResult &memres, Byte *data,
                   const Byte *fault);
};
