...
extern void __sift_assert_fail(__const char *__assertion, __const char *__file, unsigned int __line,
...
#define sift_assert(expr)                                                                                              \
   ((expr) ? __ASSERT_VOID_CAST(0) : __sift_assert_fail(__STRING(expr), __FILE__, __LINE__, __ASSERT_FUNCTION))
