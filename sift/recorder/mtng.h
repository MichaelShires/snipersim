...
class Record
{
 public:
   ...
   ADDRINT pc;
   Record(RecordType p1, SimMode p2, uint64_t sim_fs_, const std::vector<uint64_t> &ins_num_, ADDRINT pc_)
       : record_type(p1), sim_mode(p2), sim_fs(sim_fs_), ins_num_vec(ins_num_), pc(pc_)
   {
